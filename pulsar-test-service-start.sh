...
CONTAINER_ID=$(docker run -i --user $(id -u) -p 8080:8080 -p 6650:6650 -p 8443:8443 -p 6651:6651 --rm --detach czcoder/pulsar3.3.0-c0aab49 sleep 3600)
...
CONTAINER_ID=$(docker run -i --user $(id -u) -p 8081:8081 -p 6652:6652 -p 8444:8444 -p 6653:6653 --rm --detach czcoder/pulsar3.3.0-c0aab49 sleep 3600)
